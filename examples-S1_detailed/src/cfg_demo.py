...
This file has src configs as well as specification for parameterized values in netParams.py
...
cfg.poptypeNumber = 6 # max 55 + 6
cfg.celltypeNumber = 21 # max 207 + 6
...
cfg.cellNumber['ss_RTN_o'] = 382*0.01
cfg.cellNumber['ss_RTN_m'] = 382*0.01
cfg.cellNumber['ss_RTN_i'] = 765*0.01
cfg.cellNumber['VPL_sTC'] = 656*0.01
cfg.cellNumber['VPM_sTC'] = 839*0.01
cfg.cellNumber['POm_sTC_s1'] = 685*0.01
